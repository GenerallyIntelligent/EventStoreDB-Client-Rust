...
pub use commands::{ReadStream, Subscription, SubscriptionRead, SubscriptionWrite};
...
pub mod prelude {
    ...
    pub use crate::commands::{ReadStream, Subscription, SubscriptionRead, SubscriptionWrite};
